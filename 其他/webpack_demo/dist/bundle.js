...
var _SubCounter = __webpack_require__(28);

var _SubCounter2 = _interopRequireDefault(_SubCounter);
...
var Counter = function (_React$Component) {
	...
	_createClass(Counter, [{
		...
		key: 'shouldComponentUpdata',
		value: function shouldComponentUpdata(newProps, newState) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				num < 15 ? _react2.default.createElement(_SubCounter2.default, { num: num }) : ''
			);
		}
	}]);
...
var SubCounter = function (_React$Component) {
	_inherits(SubCounter, _React$Component);

	function SubCounter() {
		_classCallCheck(this, SubCounter);

		var _this = _possibleConstructorReturn(this, (SubCounter.__proto__ || Object.getPrototypeOf(SubCounter)).call(this, props));

		_this.state = {};
		return _this;
	}

	_createClass(SubCounter, [{
