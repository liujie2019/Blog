...
// babylon 主要把源码转成ast，Babylon是Babel中使用的JavaScript解析器。
...
class Compiler {
    ...
    parse(source, parentPath) { // AST解析语法树
        ...
        traverse(ast, {
            ...
            CallExpression(p) {
                const node = p.node;
                // 对require名称进行改造，改为'__webpack_require__'
